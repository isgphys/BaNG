...
Since 2012 we use it productively for our daily backups of over 500TB of data across several SAN servers. However, it may still contain bugs and is primarily meant for advanced users.
