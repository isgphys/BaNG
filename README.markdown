...
Since 2012 we use it productively for our daily backups of over 420TB of data across several SAN servers. However, it may still contain bugs and is primarily meant for advanced users. Please refer to the [documentation](docs/) for more details.
